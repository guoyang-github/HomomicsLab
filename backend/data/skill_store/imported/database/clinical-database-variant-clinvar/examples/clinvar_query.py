...
def search_clinvar(term, retmax=100):
    ...
    params = {
        ...
        'tool': 'clinvar_query', 'email': os.getenv('NCBI_EMAIL', '')
    }
...
def categorize_significance(clinsig):
    ...
    if 'conflicting' in clinsig_lower:
        return 'conflicting'
    elif 'pathogenic' in clinsig_lower and 'likely' not in clinsig_lower:
        return 'pathogenic'
...
if __name__ == '__main__':
    ...
    for s in summaries[:5]:
        ...
        clinical_significance = s.get('clinical_significance') or {}
        clinsig = clinical_significance.get('description', 'N/A')
        review = clinical_significance.get('review_status', 'N/A')
