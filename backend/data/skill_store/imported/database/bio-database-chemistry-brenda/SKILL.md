---
name: bio-database-chemistry-brenda
...
for cofactor in cofactors:
    ...
    print(f"Concentration: {cofactor.get('concentration', 'N/A')}")
```
...
3. **Register for BRENDA access**:
   ...
   - Use `BRENDA_EMAIL` for the environment variable
...
- Check for correct spelling of `BRENDA_EMAIL`
