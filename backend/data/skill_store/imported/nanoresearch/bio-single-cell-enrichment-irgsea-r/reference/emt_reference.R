#' EMT Gene Sets for irGSEA
#'
#' Ready-to-use EMT (Epithelial-Mesenchymal Transition) gene sets.
#' Source this file to load `emt_gene_sets` into your R environment.
#'
#' Usage:
#'   source("reference/emt_reference.R")
#'   seurat_obj <- run_irgsea_seurat(seurat_obj, gene_sets = emt_gene_sets, slot = "counts")
