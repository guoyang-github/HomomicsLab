...
Before diving into intuition pumps, the assistant should gather context by asking the user:
...
Based on the user's responses, the assistant should guide them through relevant intuition pumps from this list:
...
**Self-Check:** Will this tool application open new biological questions, or just extend existing observations? the assistant should help the user evaluate this honestly.
...
To ensure the idea has appropriate scope and hasn't been thoroughly explored, the assistant should ask:
...
the assistant should use PubMed to:
...
After working through intuition pumps, avoiding traps, and reviewing literature, the assistant should help the user:
...
At the end of this skill, the assistant should produce a **2-page Problem Ideation Document** containing:
