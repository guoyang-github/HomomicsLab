...
```latex
% Simple format
\author{\textbf{Author One}\textsuperscript{1}, Author Two\textsuperscript{2}}
\institute{
...
\institute{
  ...
  \textsuperscript{*}author@university.edu
}
```
...
**Format**:
```
Contact: Author Name, author@university.edu
Lab: lab.university.edu | Social: @labhandle
```
