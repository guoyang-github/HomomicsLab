...
# Reference: anndata 0.10+, numpy 1.26+, pandas 2.2+, scanpy 1.10+, spatialdata 0.1+ | Verify API if version differs

import scanpy as sc

# scanpy 1.10+ provides sc.read_visium(); squidpy's sq.read.visium() is deprecated.
