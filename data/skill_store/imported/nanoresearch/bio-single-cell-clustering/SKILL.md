...
```python
# Louvain clustering (deprecated; prefer Leiden)
# Note: scanpy 1.10+ recommends Leiden. Louvain remains for backward compatibility.
...
- bio-single-cell-preprocessing - Data must be preprocessed before clustering
- bio-single-cell-cell-annotation - Find markers and annotate each cluster
- bio-single-cell-data-io - Save clustered results
