...
Tell your AI agent:
- "Calculate translation efficiency from my Ribo-seq and mRNA-seq"
...
> "Calculate TE for each gene using Ribo-seq and mRNA-seq counts"
...
1. Load Ribo-seq and mRNA-seq count matrices
...
- **Match samples** - Ribo-seq and mRNA-seq must be from same biological samples
- **CDS counts for Ribo-seq** - only count in coding sequence
- **Full transcript for mRNA-seq** - include UTRs
