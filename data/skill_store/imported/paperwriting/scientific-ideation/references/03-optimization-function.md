...
First, the assistant should determine what type of project the user is pursuing:
...
Based on the answers, the assistant should help identify the right optimization function.
...
This is where the assistant explicitly discusses the user's belief system about what matters:
...
the assistant should use PubMed to benchmark impact in the user's area:
...
the assistant should produce a **2-page Impact Assessment Document**:
...
the assistant should begin Phase 1 by asking:
1. What is the primary goal? (A/B/C/D)
2. What would success look like in 3-5 years?
3. Who cares if this succeeds?

Together, the assistant and the user will select the right optimization function and position the work for maximum impact.
