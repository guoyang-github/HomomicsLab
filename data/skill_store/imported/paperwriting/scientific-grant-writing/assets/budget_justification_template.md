...
**Example**:
*Collaborating Institution Subaward*

*Total costs*: $100,000/year

*Justification*: The collaborating institution will perform all mass spectrometry-based metabolomics and proteomics analyses for Aims 1-2. The Director of their Metabolomics Core will lead these efforts. This collaboration is essential because our institution lacks the specialized mass spectrometry platforms (Orbitrap Fusion, QTOF) and expertise required for these analyses. The collaborator has extensive experience with T2D metabolomics and proteomics, having processed >5,000 clinical samples.
...
*Budget includes*: Personnel (50% technician, 10% Core Director), supplies, and instrument time. Detailed subaward budget attached.
