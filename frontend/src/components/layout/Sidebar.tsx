...
const navItems: SidebarItem[] = [
  ...
  { id: 'workflow', label: '工作流', icon: Workflow, shortcut: '⌘2' },
  { id: 'reports', label: '报告', icon: FileText, shortcut: '⌘3' },
  { id: 'skills', label: 'Skills', icon: FlaskConical, shortcut: '⌘4' },
  { id: 'domains', label: 'Domains', icon: FolderOpen, shortcut: '⌘5' },
