"""Generalization test: bio-single-cell-data-io on a small h5ad."""
import asyncio
import json
import os
import sys
...
async def main():
    skill_dir = Path("/mnt/c/Users/guoyang/Desktop/TEST/HomomicsLab/skills/bio-single-cell-data-io")
    data_path = "/mnt/c/Users/guoyang/Desktop/data/PA12_small.h5ad"
    working_dir = Path("/mnt/c/Users/guoyang/Desktop/TEST/HomomicsLab/tmp_dbg/dataio_small")
    ...
    inputs = {
        ...
        "user_request": "Load the h5ad file, detect its format, and export a CSV summary of obs metadata (n_cells, obs columns, and value counts for all_celltype).",
    }
