"""Direct integration test for CellTypist skill script-first execution."""
...
async def main():
    ...
    data_path = "/mnt/c/Users/guoyang/Desktop/DemoShot/PA12_sc.h5ad"
    working_dir = Path("/mnt/c/Users/guoyang/Desktop/TEST/HomomicsLab/tmp_dbg/celltypist_test")
    ...
    print(f"Runtime type: {skill.runtime.type}")
    print(f"Source dir: {skill.source_dir}")
    ...
    print(f"Default model: {getattr(llm_client, '_default_model', 'unknown')}")
